...
export default function Footer(props: {light: boolean}) {
  ...
  return (
    <div className={` flex flex-col items-center ${light ? "bg-white" : "bg-zinc-400"}`}>
        <h2 className={`text-2xl lg:text-5xl font-bold ${light ? "text-slate-700" : "text-white"} my-5`}>CONTACT ME</h2>
        <p className={`text-lg text-center ${light ? "text-slate-500" : "text-white"} my-5`}>designed and programmed by HoushtoulBack, a frontEnd developer</p>
